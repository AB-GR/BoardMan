...
namespace BoardMan.Web.Migrations
{
    ...
    [Migration("20220325060605_ActivityTableChanges")]
    partial class ActivityTableChanges
    {
            ...
            modelBuilder.Entity("BoardMan.Web.Data.DbPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("40ef4405-d774-4943-a08f-8a9b995f7617"),
                            Cost = 99m,
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7150),
                            Currency = "USD",
                            Description = "This is the standard monthly plan",
                            ExpireAt = new DateTime(2023, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7154),
                            Name = "Standard (Monthly)",
                            PlanType = 0
                        },
                        new
                        {
                            Id = new Guid("48a672e4-dd3c-4d65-a318-a8927a7b5a56"),
                            Cost = 948m,
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7182),
                            Currency = "USD",
                            Description = "This is the standard annual plan",
                            ExpireAt = new DateTime(2023, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7183),
                            Name = "Standard (Annual)",
                            PlanType = 1
                        },
                        new
                        {
                            Id = new Guid("5ae8bf83-fc8b-4655-b587-9ebd992f4cee"),
                            Cost = 299m,
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7253),
                            Currency = "USD",
                            Description = "This is the premium monthly plan",
                            ExpireAt = new DateTime(2023, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7254),
                            Name = "Premium (Monthly)",
                            PlanType = 0
                        },
                        new
                        {
                            Id = new Guid("dd20fc35-77cf-432e-a7c0-24bf78623857"),
                            Cost = 3000m,
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7266),
                            Currency = "USD",
                            Description = "This is the premium annual plan",
                            ExpireAt = new DateTime(2023, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7267),
                            Name = "Premium (Annual)",
                            PlanType = 1
                        });
                });
            ...
            modelBuilder.Entity("BoardMan.Web.Data.DbRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47f97124-c8fa-45a4-a304-d5638f16b973"),
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7283),
                            Description = "This is a readonly role meant to give view access to users",
                            Name = "Read-Only"
                        },
                        new
                        {
                            Id = new Guid("f28f00a9-5f84-45a6-857d-b9c60bf71d06"),
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7295),
                            Description = "This is a readwrite role meant to give access to read and write different entities",
                            Name = "Read-Write"
                        },
                        new
                        {
                            Id = new Guid("26f1e366-6d41-4ccc-a436-c0601786112b"),
                            CreatedAt = new DateTime(2022, 3, 25, 6, 6, 4, 369, DateTimeKind.Utc).AddTicks(7305),
